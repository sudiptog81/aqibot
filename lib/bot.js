...
const trigger = new Command("discord-aqi");
  ...
  .action(async () => {
    await sendMessage(
      new Discord.MessageEmbed()
        ...
        .setTitle("Help Menu")
        .setDescription(
          dedent`\`\`\`!aqi brief <stn>: Brief Information about the Air Quality
            !aqi info <stn>: Detailed Information about the Air Quality
